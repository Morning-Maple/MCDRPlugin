"""
pack.py — 将 MailMaple 打包为 .mcdr 插件文件

用法:
    python pack.py

输出:
    MailMaple-v{version}.mcdr
...
OUTPUT_NAME = f"MailMaple-v{version}.mcdr"
# 输出目录: 仓库根目录下的 output/
...
if __name__ == "__main__":
    print(f"正在打包 MailMaple v{version} ...\n")
    pack()
